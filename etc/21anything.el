(use-package anything-startup
  ...
  (define-key anything-map (kbd "C-s")   'anything-select-3rd-action)
  ...
  (define-key (anything-read-file-name-map) (kbd "C-s") 'anything-select-3rd-action)
  ...
  (use-package anything-c-javadoc
    :config
  ...
  (use-package cl)  ;; loop, delete-duplicates
