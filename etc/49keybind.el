...
; history of points at which is edited
...
(use-package anything-c-source-mark-ring
  :config
...
(define-key elscreen-map (kbd "c")   'elscreen-kill)
(define-key elscreen-map (kbd "C-c") 'elscreen-kill)
